...
def interpolation_country_bs5975(height, km):
    km = float(km)
    height = float(height)
    ...
    print("Interpolated country exposure factor: " + str(round(r, 3)))
    return r


def interpolation_town_bs5975(height, km):
    km = float(km)
    height = float(height)
    ...
    print("Interpolated town exposure factor: " + str(round(r, 3)))
    return r
...
def wind_bs5975(height):
    ...
    if town: # if town == true
        exposure_factor = interpolation_town_bs5975(height, distance_shore)
    else:
        exposure_factor = interpolation_country_bs5975(height, distance_shore)
